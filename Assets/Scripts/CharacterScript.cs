...
public class CharacterMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Space) && (Array.Exists(raycastHitUp, x => x.collider.gameObject.name.Equals("Terrain")) || Array.Exists(raycastHitDown, x => x.collider.gameObject.name.Equals("Terrain"))))
        {
